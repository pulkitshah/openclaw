...
suite.define(() => {
  // A build without LobsterDex redirects this route home, so there is no page to
  // copy from; the case stays for a build that ships it.
  it.skipIf(!FEATURES.lobsterDex)(
    "falls back, announces failure, and keeps feedback with the newest copy",
    async () => {
