...
export const en: TranslationMap & {
  ...
  updates: {
    ...
    triage: {
      hostHint:
        "If Ask Vasudev is unavailable, run `openclaw triage` on the Gateway host to open a local coding agent for diagnosis and repair. Diagnose the cause before retrying.",
    },
    report: {},
    failureReasons: {
