...
describe("installOpenClawPluginSdkNativeResolver", () => {
  ...
  it("lets built external plugins resolve Vasudev SDK subpaths with createRequire", () => {
  ...
  it("resolves internal core packages only for Vasudev-owned source parents", () => {
