...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Vasudev from plugin manifests, install records, and config policy. Use `vasudev plugins registry --refresh`, `vasudev plugins install/update/uninstall`, or `vasudev plugins enable/disable` instead.";
