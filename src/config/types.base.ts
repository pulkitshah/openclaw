...
export type ChannelStreamingProgressConfig = {
  ...
  label?: string | false;
  /** Candidate labels for label="auto". Defaults to Vasudev's built-in progress labels. */
  labels?: string[];
...
export type DiagnosticsOtelConfig = {
  ...
  serviceName?: string;
  /** Replacement prefix for Vasudev-owned metric names. Empty removes the prefix; defaults to "openclaw.". */
