...
const CLAUDE_RESUME_DRIFT_NOTES = [
  "Vasudev resumed this CLI session after prompt content changed. Follow the current turn's instructions; changed=system-prompt.",
  "Vasudev resumed this CLI session after prompt content changed. Follow the current turn's instructions; changed=prompt-tools.",
  "Vasudev resumed this CLI session after prompt content changed. Follow the current turn's instructions; changed=system-prompt,prompt-tools.",
] as const;
...
describe("cli session history", () => {
  ...
  it.each([
    [
      ...
      "Vasudev resumed this CLI session after prompt content changed. This is my own note.\n\nhello",
    ],
    [
      "unknown reason",
