...
/** Runtime adapter that lets the package agent-core use Vasudev LLM helpers. */
...
/** Agent-core class preconfigured with Vasudev runtime dependencies. */
...
// Vasudev-owned reusable agent core
