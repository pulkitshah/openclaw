...
describe("resolveGatewayService", () => {
  ...
  it("guards mutating service adapters when config was written by a newer Vasudev", async () => {
...
describe("readGatewayServiceState", () => {
  ...
  it.each([
    { name: "system-scoped Vasudev service", definition: true, installed: true },
    { name: "missing Vasudev service definition", definition: false, installed: false },
