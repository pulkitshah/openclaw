...
describe("listThinkingLevels", () => {
  ...
  it("honors provider-owned thinking maps before compat and derives Vasudev Ultra", () => {
    const catalog = [
      {
        provider: "custom",
        id: "reasoning-model",
  ...
  it("uses advanced catalog efforts and derives Vasudev Ultra from Max", () => {
    const catalog = [
      {
        provider: "myazure",
        id: "gpt-5.6-sol",
  ...
  it("preserves catalog-advertised Ultra for non-Vasudev runtimes", () => {
    const catalog = [
      {
        provider: "myazure",
        id: "gpt-5.6-sol",
