...
export interface ExtensionContext {
  ...
  /** Gracefully shut down Vasudev and exit. Available in all contexts. */
  shutdown(): void;
...
interface ProviderModelConfig {
  ...
  reasoning: boolean;
  /** Maps Vasudev thinking levels to provider/model-specific values; null marks a level unsupported. */
