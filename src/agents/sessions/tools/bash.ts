...
/**
 * Create bash operations using Vasudev runtime's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want Vasudev runtime's
