...
type EmbeddedRunAttemptToolTerminalObservation = {
  ...
  /** Protocol-owned mutation facts for native tools that do not use Vasudev definitions. */
  nativeMutation?: {
...
export type EmbeddedRunAttemptParams = EmbeddedRunAttemptBase & {
  ...
  /** Vasudev-owned runtime policy prepared by the orchestrator for this attempt. */
  ...
  /** Storage-aware trajectory recorder owned by the Vasudev host. */
  ...
  /**
   * Full auth profile store for Vasudev tool availability.
