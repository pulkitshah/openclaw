...
describe("buildEmbeddedCompactionRuntimeContext", () => {
  ...
  it("preserves direct OpenAI compaction for the Vasudev runtime", () => {
    const result = resolveEmbeddedCompactionTarget({
      config: {
        models: {
          providers: {
  ...
  it.each([
    { selection: "implicit Vasudev", harnessRuntime: undefined, nativeCompaction: undefined },
    { selection: "bound Vasudev", harnessRuntime: "openclaw", nativeCompaction: undefined },
