  ...
  it.each([
    {
      ...
      message: 'Agent "агент✨" not found. Run vasudev agents list to see configured agents.',
    },
    {
      name: "bindings with an unknown agent",
      command: "bindings",
      options: { agent: "ghost", json: true },
      message: 'Agent "ghost" not found. Run vasudev agents list to see configured agents.',
    },
    {
    ...
    },
    {
      ...
      message: 'Agent "   " not found. Run vasudev agents list to see configured agents.',
    },
    {
