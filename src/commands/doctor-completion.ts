    ...
    return [
      {
        ...
        path: pathLocal,
        fixHint: "Run `vasudev doctor --fix` to upgrade to cached completion.",
      },
    ];
  }
    ...
    return [
      {
        ...
        path: pathLocal,
        fixHint: `Run \`vasudev completion --write-state\` or \`vasudev doctor --fix\` to regenerate ${status.cachePath}.`,
      },
    ];
  }
  return [];
