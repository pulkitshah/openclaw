      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run vasudev plugins install @openclaw/feishu or vasudev doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run vasudev doctor --fix",
        },
      ],
      details: [],
    });
