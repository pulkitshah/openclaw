...
// Vasudev operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Vasudev itself navigated to a blocked URL.
...
/** Quarantine and close a tab that Vasudev navigated to a blocked URL. */
