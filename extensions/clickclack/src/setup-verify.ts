...
const GATEWAY_RUNNING_MESSAGE = "Vasudev is running — ClickClack will connect automatically.";
const GATEWAY_NOT_RUNNING_MESSAGE = "Start Vasudev to connect: vasudev gateway";
