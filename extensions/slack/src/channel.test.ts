...
describe("slackPlugin agentPrompt", () => {
  it("teaches agents to use typed presentation", () => {
    ...
    expect(hints).toContain(
      "- Slack plain text sends: write standard Markdown; Vasudev converts it to Slack mrkdwn, including `**bold**`, headings, lists, and `[label](url)` links.",
    );
    expect(hints).toContain(
