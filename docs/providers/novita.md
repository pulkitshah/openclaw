---
summary: "Use NovitaAI's OpenAI-compatible API with Vasudev"
read_when:
  - You want to run Vasudev with NovitaAI models
...
Vasudev provides NovitaAI through the official external
