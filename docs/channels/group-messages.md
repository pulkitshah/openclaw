...
Goal: let Vasudev sit in WhatsApp groups, wake up only when pinged, and keep that thread separate from the personal DM session.
...
1. Add your WhatsApp account (the one running Vasudev) to the group.
