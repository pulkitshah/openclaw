...
Teams delivers messages via HTTP webhook. Vasudev applies fixed HTTP server
...
| Teams environment | Vasudev config                                              | Proactive `serviceUrl`                             |
| ----------------- | ----------------------------------------------------------- | -------------------------------------------------- |
