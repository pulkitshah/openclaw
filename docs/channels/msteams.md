...
- <a id="step-6%3A-configure-openclaw" />[Step 6: Configure Vasudev](/channels/msteams/setup#step-6%3A-configure-vasudev)
- <a id="step-6-configure-openclaw" />[Step 6: Configure Vasudev](/channels/msteams/setup#step-6-configure-vasudev)
