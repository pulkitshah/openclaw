...
Run the channel setup wizard, then understand how Vasudev durably accepts inbound Feishu events.

## Quick start

<Note>
Requires Vasudev 2026.5.29 or above. Run `openclaw --version` to check. Upgrade with `openclaw update`.
</Note>
