...
Vasudev uses OpenAI embeddings by default. To use another provider, set it
explicitly:
...
Choose llama.cpp once in interactive setup. Vasudev installs a verified
...
Vasudev runs two retrieval paths in parallel and merges the results:
