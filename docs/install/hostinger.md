---
summary: "Host Vasudev on Hostinger"
read_when:
  - Setting up Vasudev on Hostinger
  - Looking for a managed VPS for Vasudev
  - Using Hostinger 1-Click Vasudev
title: "Hostinger"
---

Run a persistent Vasudev Gateway on [Hostinger](https://www.hostinger.com/openclaw). Choose a **1-Click** managed deployment, or a **VPS** install you administer yourself.
...
<Steps>
  <Step title="Purchase and launch">
    1. From the [Hostinger Vasudev page](https://www.hostinger.com/openclaw), choose a Managed Vasudev plan and complete checkout.

    <Note>
    During checkout you can select **Ready-to-Use AI** credits. These credits are pre-purchased and integrated instantly inside Vasudev. You need no external accounts or API keys from other providers. You can start chatting right away. Alternatively, provide your own key from Anthropic, OpenAI, Google Gemini, or xAI during setup.
    </Note>
  ...
  <Step title="Complete installation">
    Click **Finish** to deploy the instance. Once ready, access the Vasudev dashboard from **Vasudev Overview** in hPanel.
  </Step>

</Steps>

## Option B: Vasudev on VPS

More control over the server. Hostinger deploys Vasudev via Docker on your VPS. You manage it through the **Docker Manager** in hPanel.
...
<Steps>
  ...
  <Step title="Start Vasudev">
    Click **Deploy**. Once running, open the Vasudev dashboard from the hPanel by clicking on **Open**.
  </Step>
...
Send "Hi" to your assistant on the channel you connected. Vasudev replies and walks you through initial preferences.
...
**Telegram bot not responding** -- With DM pairing required, an unknown sender gets a short pairing code, not a reply. Approve it from the Vasudev dashboard chat. You can also run `openclaw pairing approve telegram <CODE>` if you have shell access to the container. See [Pairing](/channels/pairing).
