...
`pnpm test:docker:all` prebuilds one shared live-test image, packs Vasudev once as an npm tarball, and builds two shared `scripts/e2e/Dockerfile` images:
