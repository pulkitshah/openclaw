...
How Vasudev captures a prepared project and node runtime before enrollment, reuses that image for later workers, and how to recover a capture that was left uncertain.
...
held, capturing, or pinned. Vasudev retains the ownership record until provider
