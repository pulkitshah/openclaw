...
During startup or restart, the Gateway waits up to five minutes for another Vasudev process to release lifecycle ownership, logging when it starts waiting and when it acquires ownership or times out.
