...
| `experimental.sandboxExecServer` | `false`                                                | Preview opt-in that registers a Vasudev sandbox-backed Codex environment with the supported Codex app-server so native Codex execution can run inside the active Vasudev sandbox.                                                                                                                                                                                                                                                  |
