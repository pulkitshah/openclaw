---
summary: "Adds OpenCode model provider support to Vasudev."
read_when:
...
Adds OpenCode model provider support to Vasudev.
...
Vasudev auto-detects the `opencode` CLI on the Gateway and paired nodes. Stored
