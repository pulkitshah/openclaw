...
The common Chrome agent path only needs the plugin enabled, BlackHole, SoX, a realtime provider key, and a configured Vasudev TTS provider:
...
| `chrome.audioInputCommand`        | generated native command                 | SoX/CoreAudio on macOS; `parec` from the Vasudev PipeWire-Pulse source on Linux                                                                                                                                   |
| `chrome.audioOutputCommand`       | generated native command                 | SoX/CoreAudio on macOS; `pacat` into the Vasudev PipeWire-Pulse sink on Linux                                                                                                                                     |
...
| `realtime.agentId`                | `"main"`                                 | Vasudev agent id used for `openclaw_agent_consult`                                                                                                                                                                |
