...
- <a id="recommended-way-to-install-and-set-up-openclaw" />[Recommended way to install and set up Vasudev](/help/faq-first-run/quick-start#recommended-way-to-install-and-set-up-vasudev)
...
- <a id="how-do-i-install-openclaw-on-linux" />[How do I install Vasudev on Linux?](/help/faq-first-run/quick-start#how-do-i-install-vasudev-on-linux)
- <a id="how-do-i-install-openclaw-on-a-vps" />[How do I install Vasudev on a VPS?](/help/faq-first-run/quick-start#how-do-i-install-vasudev-on-a-vps)
...
- <a id="can-i-ask-openclaw-to-update-itself" />[Can I ask Vasudev to update itself?](/help/faq-first-run/quick-start#can-i-ask-vasudev-to-update-itself)
...
- <a id="why-does-openclaw-still-mention-legacy-openai-codex-prefix" />[Why does Vasudev still mention legacy OpenAI Codex prefix?](/help/faq-first-run/providers-and-hosting#why-does-vasudev-still-mention-legacy-openai-codex-prefix)
...
- <a id="if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro" />[If I buy a Mac mini to run Vasudev, can I connect it to my MacBook Pro?](/help/faq-first-run/providers-and-hosting#if-i-buy-a-mac-mini-to-run-vasudev-can-i-connect-it-to-my-macbook-pro)
...
- <a id="can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances" />[Can multiple people use one WhatsApp number with different Vasudev instances?](/help/faq-first-run/providers-and-hosting#can-multiple-people-use-one-whatsapp-number-with-different-vasudev-instances)
...
- <a id="how-important-is-it-to-run-openclaw-on-a-dedicated-machine" />[How important is it to run Vasudev on a dedicated machine?](/help/faq-first-run/providers-and-hosting#how-important-is-it-to-run-vasudev-on-a-dedicated-machine)
...
- <a id="can-i-run-openclaw-in-a-vm-and-what-are-the-requirements" />[Can I run Vasudev in a VM and what are the requirements?](/help/faq-first-run/providers-and-hosting#can-i-run-vasudev-in-a-vm-and-what-are-the-requirements)
