---
summary: "Frequently asked questions about Vasudev setup, configuration, and usage"
read_when:
...
| Page                                                                                       | Read it when                                                                    |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [What is Vasudev?](/help/faq/what-is-openclaw)                                             | You are evaluating Vasudev, or explaining what it is and who funds it.          |
...
| [Where things live on disk](/help/faq/where-things-live-on-disk)                           | You need to find, back up, move, or remove Vasudev data.                        |
...
| [Security and access control](/help/faq/security-and-access-control)                       | You are exposing Vasudev to inbound messages or judging plugin risk.            |
...
- <a id="what-is-openclaw%3F" /><a id="what-is-openclaw" />[What is Vasudev?](/help/faq/what-is-openclaw#what-is-vasudev)
- <a id="what-is-openclaw-in-one-paragraph" />[What is Vasudev, in one paragraph?](/help/faq/what-is-openclaw#what-is-vasudev-in-one-paragraph)
- <a id="can-my-team-share-one-openclaw" />[Can my team share one Vasudev?](/help/faq/what-is-openclaw#can-my-team-share-one-vasudev)
...
- <a id="what-are-the-top-five-everyday-use-cases-for-openclaw" />[What are the top five everyday use cases for Vasudev?](/help/faq/what-is-openclaw#what-are-the-top-five-everyday-use-cases-for-vasudev)
- <a id="can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas" />[Can Vasudev help with lead gen, outreach, ads, and blogs for a SaaS?](/help/faq/what-is-openclaw#can-vasudev-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
- <a id="is-openclaw-owned-by-openai" />[Is Vasudev owned by OpenAI?](/help/faq/what-is-openclaw#is-vasudev-owned-by-openai)
- <a id="what-does-openclaw-send-to-the-foundation" />[What does Vasudev send to the Foundation?](/help/faq/what-is-openclaw#what-does-vasudev-send-to-the-foundation)
- <a id="how-is-openclaw-funded-and-how-does-that-compare" />[How is Vasudev funded, and how does that compare?](/help/faq/what-is-openclaw#how-is-vasudev-funded-and-how-does-that-compare)
...
- <a id="can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background" />[Can Vasudev run tasks on a schedule or continuously in the background?](/help/faq/skills-and-automation#can-vasudev-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- <a id="how-do-i-use-my-existing-signed-in-chrome-with-openclaw" />[How do I use my existing signed-in Chrome with Vasudev?](/help/faq/skills-and-automation#how-do-i-use-my-existing-signed-in-chrome-with-vasudev)
...
- <a id="is-all-data-used-with-openclaw-saved-locally" />[Is all data used with Vasudev saved locally?](/help/faq/where-things-live-on-disk#is-all-data-used-with-vasudev-saved-locally)
- <a id="where-does-openclaw-store-its-data" />[Where does Vasudev store its data?](/help/faq/where-things-live-on-disk#where-does-vasudev-store-its-data)
...
- <a id="how-do-i-completely-uninstall-openclaw" />[How do I completely uninstall Vasudev?](/help/faq/where-things-live-on-disk#how-do-i-completely-uninstall-vasudev)
...
- <a id="can-the-openclaw-browser-run-headless" />[Can the Vasudev browser run headless?](/help/faq/config-basics#can-the-vasudev-browser-run-headless)
...
- <a id="can-two-openclaw-instances-talk-to-each-other-local-vps" />[Can two Vasudev instances talk to each other (local + VPS)?](/help/faq/remote-gateways-and-nodes#can-two-vasudev-instances-talk-to-each-other-local-vps)
...
- <a id="how-does-openclaw-load-environment-variables" />[How does Vasudev load environment variables?](/help/faq/env-vars#how-does-vasudev-load-environment-variables)
...
- <a id="is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents" />[Is there a way to make a team of Vasudev instances (one CEO and many agents)?](/help/faq/sessions-and-chats#is-there-a-way-to-make-a-team-of-vasudev-instances-one-ceo-and-many-agents)
...
- <a id="how-do-i-completely-reset-openclaw-but-keep-it-installed" />[How do I completely reset Vasudev but keep it installed?](/help/faq/sessions-and-chats#how-do-i-completely-reset-vasudev-but-keep-it-installed)
...
- <a id="why-does-openclaw-not-reply-in-a-group" />[Why does Vasudev not reply in a group?](/help/faq/sessions-and-chats#why-does-vasudev-not-reply-in-a-group)
...
- <a id="how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere" />[How do I run Vasudev in remote mode (client connects to a Gateway elsewhere)?](/help/faq/gateway-ports-and-remote-mode#how-do-i-run-vasudev-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- <a id="i-closed-my-terminal-on-windows-how-do-i-restart-openclaw" />[I closed my terminal on Windows - how do I restart Vasudev?](/help/faq/logging-and-debugging#i-closed-my-terminal-on-windows-how-do-i-restart-vasudev)
...
- <a id="is-it-safe-to-expose-openclaw-to-inbound-dms" />[Is it safe to expose Vasudev to inbound DMs?](/help/faq/security-and-access-control#is-it-safe-to-expose-vasudev-to-inbound-dms)
...
- <a id="is-openclaw-less-safe-because-it-uses-typescript-node-instead-of-rust-wasm" />[Is Vasudev less safe because it uses TypeScript/Node instead of Rust/WASM?](/help/faq/security-and-access-control#is-vasudev-less-safe-because-it-uses-typescript-node-instead-of-rust-wasm)
- <a id="i-saw-reports-about-exposed-openclaw-instances-what-should-i-check" />[I saw reports about exposed Vasudev instances. What should I check?](/help/faq/security-and-access-control#i-saw-reports-about-exposed-vasudev-instances-what-should-i-check)
