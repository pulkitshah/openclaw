...
/** Provider API families with first-class request/stream adapters in Vasudev. */
...
/** Image-generation API families with first-class adapters in Vasudev. */
...
/** Image provider ids with first-class adapters in Vasudev. */
