...
/** Install Vasudev-owned loop control without adding a plugin-facing Agent option. */
...
/** Attach Vasudev-owned two-phase execution without changing the public AgentTool shape. */
